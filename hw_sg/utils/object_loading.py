...
import hw_sg.augmentations
import hw_sg.datasets
from hw_sg import batch_sampler as batch_sampler_module
from hw_sg.base.base_text_encoder import BaseTextEncoder
from hw_sg.collate_fn.collate import collate_fn
...
def get_dataloaders(configs: ConfigParser):
    ...
    for split, params in configs["data"].items():
        ...
        if split == 'train':
            wave_augs, spec_augs = hw_sg.augmentations.from_configs(configs)
            drop_last = True
        else:
